...
I am building Indonesia AI Builder Starter Kit, an early open-source educational infrastructure project for Indonesian beginner AI builders.
...
This project helps Indonesian beginners who want to build with AI but are still unfamiliar with project planning, GitHub, PRDs, prompt structure, documentation, deployment, and open-source contribution.

The target users include beginner creators, students, solo founders, small business owners, and self-taught builders who need clear, practical, Bahasa Indonesia-first learning resources.

## Suggested application answer: What impact do you hope to create?
...
## Suggested application answer: Why do you need Claude?

Claude is especially useful for the planning, reasoning, documentation, and educational side of this project.

I want to use Claude to improve project templates, create clearer beginner documentation, review project structures, generate localized examples, and help maintain a high-quality open-source resource for Indonesian AI builders.

Claude can also help users of this starter kit turn rough ideas into structured PRDs, project briefs, and implementation instructions before they start coding.
...
- Built to support Indonesian beginner AI builders
