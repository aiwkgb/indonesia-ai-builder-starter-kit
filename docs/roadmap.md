...
- Prompt pack examples for Claude and Codex
- Digital product landing page example

## v0.2.0

- Add bilingual English and Indonesian docs
- Add more real-world examples
- Improve navigation between docs, templates, checklists, and examples
- Add reusable project section patterns
- Improve contribution guidance for beginner contributors
...
- More local Indonesian business use cases
- Simple scaffold generator
- Beginner-friendly GitHub issue templates for docs, examples, and templates
